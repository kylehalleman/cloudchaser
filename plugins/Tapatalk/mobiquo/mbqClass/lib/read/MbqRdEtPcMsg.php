...
Class MbqRdEtPcMsg extends MbqBaseRdEtPcMsg {
    ...
    public function initOMbqEtPcMsg($var, $mbqOpt) {
        if ($mbqOpt['case'] == 'oStdPcMsg') {
            ...
            $oMbqEtPcMsg->msgContent->setTmlDisplayValue($this->processPcMsgContentForDisplay($var->FormatBody, true));
            $oMbqEtPcMsg->msgContent->setTmlDisplayValueNoHtml($this->processPcMsgContentForDisplay($var->FormatBody, false));
