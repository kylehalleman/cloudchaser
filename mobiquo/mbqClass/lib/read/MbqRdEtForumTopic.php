...
Class MbqRdEtForumTopic extends MbqBaseRdEtForumTopic {
    ...
    public function initOMbqEtForumTopic($var, $mbqOpt) {
        if ($mbqOpt['case'] == 'oStdForumTopic') {
            ...
            $oMbqEtForumTopic->totalPostNum->setOriValue($var->CountComments);
            ...
            $oMbqEtForumTopic->replyNumber->setOriValue($var->CountComments - 1);
            ...
            $oMbqRdEtForum = MbqMain::$oClk->newObj('MbqRdEtForum');
            $oMbqEtForumTopic->objsBreadcrumbMbqEtForum = $oMbqRdEtForum->getObjsBreadcrumbMbqEtForum($oMbqEtForumTopic->forumId->oriValue);
